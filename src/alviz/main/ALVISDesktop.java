...
public class ALVISDesktop extends javax.swing.JFrame {
        ...
        switch (app.execState) {
            case APPLICATION_STARTED: {
                ...
                algoMenu.setEnabled(true);
                    ...
                    algoMYSEARCHButton.setEnabled(true);  // enabled after integration
            ...
            case ALGO_SELECTED: {
                ...
                if (app.isPipeMode()) {
                    ...
                    /*if (app.isGameTree()) {
                        ...
                        algoMYSEARCHButton.setEnabled(false);
    ...
    private void initComponents() {
        ...
        algoMYSEARCHButton = new javax.swing.JMenuItem();
        ...
        algoMYSEARCHButton.setText("MYSEARCH");
        algoMYSEARCHButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                algoMYSEARCHButtonActionPerformed(evt);
            }
        });
        algoMenu.add(algoMYSEARCHButton);
    ...
    private void algoDFSButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_algoDFSButtonActionPerformed
     ...
     private void algoMYSEARCHButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_algoMYSEARCHButtonActionPerformed
        // TODO add your handling code here:
        algoActionPerformedHelper(evt);
    }//GEN-LAST:event_algoMYSEARCHButtonActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem algoMYSEARCHButton;
